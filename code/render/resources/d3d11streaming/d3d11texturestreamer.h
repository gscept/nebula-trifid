...
//------------------------------------------------------------------------------
/**
    @class Resources::D3D11TextureStreamer
...
class D3D11TextureStreamer : public Resources::StreamResourceLoader
{
    __DeclareClass(D3D11TextureStreamer);

public:
    D3D11TextureStreamer();
    ~D3D11TextureStreamer();
...
protected:
    ...
    virtual void LockSurfaces(Util::Array<D3D11_MAPPED_SUBRESOURCE>& lockedRects, const Ptr<CoreGraphics::Texture>& tex, SizeT numMipsToLock = -1);
    ...
    void GetSurfaceInfo(uint width, uint height, DXGI_FORMAT fmt, uint* pNumBytes, uint* pRowBytes, uint* pNumRows) const;
    ...
    uint GetNumRows(uint height, DXGI_FORMAT fmt) const;
...
*/
inline void
D3D11TextureStreamer::SetReuseTexture(const Ptr<CoreGraphics::Texture>& tex)
{
...
D3D11TextureStreamer::GetReuseTexture() const
{
