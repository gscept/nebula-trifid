...
private:
    ...
    const Util::Array<Ptr<ModelNode>>& GetVisibleModelNodes(const Materials::MaterialType::Code& t) const;
    ...
    void AddVisibleModelNode(IndexT frameIndex, const Materials::MaterialType::Code& t, const Ptr<ModelNode>& modelNode);
...
*/
inline const Util::Array<Ptr<ModelNode> >&
Model::GetVisibleModelNodes(const Materials::MaterialType::Code& t) const
{
