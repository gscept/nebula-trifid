...
namespace Tests
{
__ImplementSingleton(HavokHelloWorldApplication);

//------------------------------------------------------------------------------
/**
*/
HavokHelloWorldApplication::HavokHelloWorldApplication()
{
...
*/
bool 
HavokHelloWorldApplication::Open()
{
...
*/
void 
HavokHelloWorldApplication::Close()
{
...
*/
void 
HavokHelloWorldApplication::SetupStateHandlers()
{
	this->havokState = HavokHelloWorldState::Create();
	this->havokState->SetSetupMode(GameStateHandler::NewGame);
	this->havokState->SetName("HavokHelloWorldState");
	this->havokState->SetLevelName("empty");

	this->AddStateHandler(this->havokState.get());

	this->SetState("HavokHelloWorldState");
}
...
*/
void 
HavokHelloWorldApplication::CleanupStateHandlers()
{
...
*/
void 
HavokHelloWorldApplication::SetupGameFeatures()
{
...
*/
void 
HavokHelloWorldApplication::CleanupGameFeatures()
{
