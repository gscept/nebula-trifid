...
namespace Tests
{
__ImplementSingleton(HavokLoadAssetApplication);

//------------------------------------------------------------------------------
/**
*/
HavokLoadAssetApplication::HavokLoadAssetApplication()
{
...
*/
bool 
HavokLoadAssetApplication::Open()
{
...
*/
void 
HavokLoadAssetApplication::Close()
{
...
*/
void 
HavokLoadAssetApplication::SetupStateHandlers()
{
	this->havokState = HavokLoadAssetState::Create();
	this->havokState->SetSetupMode(GameStateHandler::NewGame);
	this->havokState->SetName("HavokLoadAssetState");
	this->havokState->SetLevelName("empty");

	this->AddStateHandler(this->havokState.get());

	this->SetState("HavokLoadAssetState");
}
...
*/
void 
HavokLoadAssetApplication::CleanupStateHandlers()
{
...
*/
void 
HavokLoadAssetApplication::SetupGameFeatures()
{
...
*/
void 
HavokLoadAssetApplication::CleanupGameFeatures()
{
