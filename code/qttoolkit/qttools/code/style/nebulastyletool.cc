...
NebulaStyleTool::NebulaStyleTool()
{
	...
	QString menuSetup = ".QMenu { border: 1px solid palette(dark); border-bottom-left-radius: 2px; border-bottom-right-radius: 2px; }";
	...
	QString colorButtonsSetup = ".QtToolkitUtil--ColorToolButton, .QtToolkitUtil--ColorPushButton { background: 0; border: 1px solid palette(dark); border-radius: 2px; margin: 2px; padding: 0px; } .QtToolkitUtil--ColorToolButton:hover, .QtToolkitUtil--ColorPushButton:hover { border: 1px solid palette(highlight); }";
