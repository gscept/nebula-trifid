...
\begin{tabular} {| c | p{15cm} |}
	\hline
	\textbf{Syntax} & \textbf{Functionality} \\ \hline
	shared & Varblock only has one API representation during application execution. This varblock is then shared by all effects implementing an identical varbuffer (name of block and members). \\ \hline
\end{tabular}
}
\end{table}
